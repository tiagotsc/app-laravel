...
//             let urlStore = document.getElementById("route_upload_update").value.replace("*", momentSession);
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data("managerFrm", () => ({
            ...
            if($("#frm").valid()){
                ...
                xhr.onload = function() { 
                    if (xhr.status === 200) {
                        ...
                        thisAlpineJS.setMsgModalConfirm('Algo errado!','Se persistir, fale com o administrador!');
                    }
        ...
        uploadStore(){ // Realiza baixa de fato usando o registro de momento da sessão
            let momentSession = document.getElementById('moment_session').value;
            let urlStore = document.getElementById("route_upload_update").value.replace("*", momentSession);
            this.hideBtsConfirm();
