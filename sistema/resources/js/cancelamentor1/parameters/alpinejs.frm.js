...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data("managerFrm", () => ({
        ...
        userRegistration: ['77777','999999','111111'],
        loading: false, // Loading botão
        buttonLabel: 'Gravar', // Texto botão
        cleanFields(){
            ...
            document.getElementById("user_registration").value = '';
        ...
        submitData(){
            if($("#frm").valid()){
                ...
                this.data.user_registration = $("#user_registration").val().join(",");
                ...
                .catch(() => {
                    ...
                    $('#user_registration').val(null).trigger("change");
