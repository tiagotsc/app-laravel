    ...
    columns: [
        ...
        { 
            ...
            render: function ( data, type, row ) {
                ...
                // let totalDetail = ` <b class="text-info" data-toggle="tooltip" data-placement="top" title="${row.count_detail_total} registros em detalhes"><i class="fa fa-info-circle text-info" aria-hidden="true"></i></b>`;
                let totalDetail = '';
        ...
        { 
            ...
            render: function ( data, type, row ) { 
                ...
                bts += `<a href="#" data-bs-toggle="modal" data-bs-target="#modal-confirm" data_url="${route_export}" class="get_lote ms-2" data_name="${row.batch_date}" data-toggle="tooltip" data-placement="top" title="Obter lote">
