...
var table = $('#list').DataTable( {
    ...
    columns: [
        ...
        { data: 'order_qtd_column', width: "8%", orderable: false},
        { data: 'order_detail_qtd_column', width: "8%", orderable: false},
        { data: 'supplier_qtd_column', width: "8%", orderable: false},
        { data: 'month_recurrence', width: "10%", orderable: false},
        { 
            data: 'user_id', 
