    ...
    columns: [
        ...
        { 
            ...
            render: function ( data, type, row ) { 
                let extension = row.name.substr(27);
                let name = row.name.substr(17,10).split('-').reverse().join('/');
        ...
        { 
            ...
            render: function ( data, type, row ) { 
                ...
                if(permissionDestroy == 1){ // Se tiver permissão habilita excluir
                    bts += `<a href="#" data-bs-toggle="modal" data-bs-target="#delete-register" class="destroy ms-2 text-danger" data_id="${row.id}" data_url="${route_destroy}" data_name="${row.name}"><i class="bi bi-trash fs-5"></i></a>`;
                }
                return bts
            }
        }
        ...
        let table1 = `<table class="table table-bordered">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th colspan="2" data-toggle="tooltip" data-placement="top" title="Qtd. de não procede">Não procede <i class="fa fa-info-circle text-info" aria-hidden="true"></i></th>
