...
var table = $('#list').DataTable( {
    ...
    columns: [
        ...
        { data: 'month_filter', width: "8%", orderable: false},
        { data: 'year_filter', width: "8%", orderable: false},
        { data: 'batch_purge', width: "8%", orderable: false},
        { data: 'month_recurrence', width: "10%", orderable: false},
        { data: 'file_archiving', width: "10%", orderable: false},
        { 
            data: 'user_id', 
